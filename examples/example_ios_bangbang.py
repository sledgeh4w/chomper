...
def hook_ns_user_defaults(emu, objc):
    bangcle_debug_log_key = objc.msg_send("NSString", "stringWithUTF8String:", "N")
...
def main():
    ...
    hook_sec_item(emu)
    hook_ns_user_defaults(emu, objc)
    ...
    encrypt_input = objc.msg_send("NSString", "stringWithUTF8String:", encrypt_data)
